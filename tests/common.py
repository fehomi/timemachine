...
class GradientTest(unittest.TestCase):
    ...
    def compare_forces(
        ...
        np.testing.assert_almost_equal(test_du_dx_2, test_du_dx)
        np.testing.assert_almost_equal(test_du_dp_2, test_du_dp)
        np.testing.assert_almost_equal(test_du_dl, test_du_dl)
        np.testing.assert_almost_equal(test_u, test_u)